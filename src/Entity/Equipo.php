...
class Equipo
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Resultado", mappedBy="resultadosvisitante")
     */
    ...
    public function addResultadosvisitante(Resultado $resultadosvisitante): self
    {
        if (!$this->resultadosvisitante->contains($resultadosvisitante)) {
            ...
            $resultadosvisitante->setResultadosvisitante($this);
        }
    ...
    public function removeResultadosvisitante(Resultado $resultadosvisitante): self
    {
        if ($this->resultadosvisitante->contains($resultadosvisitante)) {
            ...
            // set the owning side to null (unless already changed)
            if ($resultadosvisitante->getResultadosvisitante() === $this) {
                $resultadosvisitante->setResultadosvisitante(null);
            }
        }
